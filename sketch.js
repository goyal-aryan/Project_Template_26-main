...
function setup() {
    ...
    //to create playerBase, player and playerArcher
    ...
    //to create computerBase, computer and computerArcher
...
//function to create the arrow when key is pressed 
function keyPressed() {
...
//function to shoot the arrow when key is released
...
//function to create arroe for computer
...
//function to detect the collision of playerArrow
function handlePlayerArrowCollision() {
    ...
    for (var i = 0; i < playerArrows.length; i++) {
        ...
        if (
            ...
            //to display text in console when arrow collides
            console.log("Player arrow Collided")
        }
    }
}

//function to detect the collision of computerArrow
